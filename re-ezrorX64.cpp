// re-ezrorX64.cpp - 极简PE桌面环境主程序
// 作者: KMD265和"豆包AI"
// 协议: MIT License
// 编译器: TDM-GCC 4.9.2 x64
// 需要以下参数: "-Os -s -m64 -std=c++11 -DUNICODE -D_UNICODE","-luuid -lmsimg32 -lgdi32 -limm32 -lole32 -loleaut32 -lwinmm -lgdiplus -std=c++11 -Os -s -lkernel32 -lcomdlg32 -lshlwapi -m64 -lmsimg32"
// 功能: 提供PE环境下的图形化桌面、文件管理和图标启动功能
// 体积: 编译后约595KB，无任何外部依赖
